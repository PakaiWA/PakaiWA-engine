...
import (
	...
	"github.com/pakaiwa/pakaiwa/proto/waMmsRetry"
	"github.com/pakaiwa/pakaiwa/types"
	"github.com/pakaiwa/pakaiwa/types/events"
	"github.com/pakaiwa/pakaiwa/util/gcmutil"
...
//	if errors.Is(err, pakaiwa.ErrMediaDownloadFailedWith404) || errors.Is(err, pakaiwa.ErrMediaDownloadFailedWith410) {
...
//	    retryData, err := pakaiwa.DecryptMediaRetryNotification(evt, imageMsg.GetMediaKey())
