...
func (x *NoiseCertificate) Reset() {
	*x = NoiseCertificate{}
	mi := &file_WACert_proto_msgTypes[0]
...
func (*NoiseCertificate) Descriptor() ([]byte, []int) {
	return file_WACert_proto_rawDescGZIP(), []int{0}
}
...
func (x *CertChain) Reset() {
	*x = CertChain{}
	mi := &file_WACert_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CertChain) Descriptor() ([]byte, []int) {
	return file_WACert_proto_rawDescGZIP(), []int{1}
}
...
func (x *NoiseCertificate_Details) Reset() {
	*x = NoiseCertificate_Details{}
	mi := &file_WACert_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NoiseCertificate_Details) Descriptor() ([]byte, []int) {
	return file_WACert_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CertChain_NoiseCertificate) Reset() {
	*x = CertChain_NoiseCertificate{}
	mi := &file_WACert_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CertChain_NoiseCertificate) Descriptor() ([]byte, []int) {
	return file_WACert_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *CertChain_NoiseCertificate_Details) Reset() {
	*x = CertChain_NoiseCertificate_Details{}
	mi := &file_WACert_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CertChain_NoiseCertificate_Details) Descriptor() ([]byte, []int) {
	return file_WACert_proto_rawDescGZIP(), []int{1, 0, 0}
}
...
var File_WACert_proto protoreflect.FileDescriptor

const file_WACert_proto_rawDesc = "" +
	"\n" +
	"\fWACert.proto\x12\x06WACert\"\xcb\x01\n" +
	...
	"\bnotAfter\x18\x05 \x01(\x04R\bnotAfterB)Z'github.com/pakaiwa/pakaiwa/proto/waCert"

var (
	file_WACert_proto_rawDescOnce sync.Once
	file_WACert_proto_rawDescData []byte
)

func file_WACert_proto_rawDescGZIP() []byte {
	file_WACert_proto_rawDescOnce.Do(func() {
		file_WACert_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_WACert_proto_rawDesc), len(file_WACert_proto_rawDesc)))
	})
	return file_WACert_proto_rawDescData
}

var file_WACert_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_WACert_proto_goTypes = []any{
...
var file_WACert_proto_depIdxs = []int32{
...
func init() { file_WACert_proto_init() }
func file_WACert_proto_init() {
	if File_WACert_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_WACert_proto_rawDesc), len(file_WACert_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_WACert_proto_goTypes,
		DependencyIndexes: file_WACert_proto_depIdxs,
		MessageInfos:      file_WACert_proto_msgTypes,
	}.Build()
	File_WACert_proto = out.File
	file_WACert_proto_goTypes = nil
	file_WACert_proto_depIdxs = nil
}
